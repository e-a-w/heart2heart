...
const FAQ = () => {
  ...
  <div>
    <h1>FAQ</h1>
    <br/>
    <h2>Finding A Matching Donor</h2>
    <p>
...
<Card>
  ...
  <Accordion.Collapse eventKey="9">
    <Card.Body>
      <p>Volunteer donors can join the Gift of Life registry either at a donor drive, or by requesting a swabbing kit on our website or by calling 800-9MARROW.</p>
      <p>Many people join registries at recruitment drives. Most drives today use swabbing kits, which use cells collected on a giant cotton swab from the inside of the cheek. The swabs are packaged and sent to a lab for tissue typing to determine the HLA markers. Once the tissue type is determined, that information is entered in the registry and made available for worldwide searches by transplant centers and physicians.</p>
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
...
<Card>
  ...
  <Accordion.Collapse eventKey="11">
    <Card.Body>
      When a donor comes up in the database as a match, the registry he or she joined is contacted by the transplant center, and asked to call the donor in for Confirmatory Typing.
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
  ...
  <Accordion.Collapse eventKey="12">
    <Card.Body>
      The prospective donor is asked for a blood draw that is sent to a laboratory for an in-depth HLA analysis to find out exactly how closely the potential donor's human leukocyte antigens — key factors in the immune system — match up with the recipient’s tissue type. A match may be a partial or a perfect match. At the same time, tests for infectious diseases are conducted.
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
...
<Card>
  ...
  <Accordion.Collapse eventKey="14">
    <Card.Body>
<p>
  Once the donor has committed to the donation, the Work Up Coordinator will arrange the donation. Whether the donation will be peripheral blood stem cells or bone marrow, everything must be set in motion so that the transplant occurs exactly when the patient is ready. The Work Up team will arrange for the donor to have a physical exam as well as any required transplant preparation, such as injections of Neupogen to stimulate stem cell production.
</p>
<p>
...
<Card>
  ...
  <Accordion.Collapse eventKey="16">
    <Card.Body>
      Stems cells regenerate naturally, so donors providing PBSCs normally feel fully recovered in 24 to 36 hours.
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
  ...
  <Accordion.Collapse eventKey="17">
    <Card.Body>
<p>
Approximately 20 percent of hematopoietic stem cell transplants in the United States are done through bone marrow collection, which is most often requested for pediatric patients. Those donating bone marrow will have a surgical procedure under general anesthesia. Marrow is drawn from the largest bone in the body, the hip bone, specifically from the iliac crest – easily found by putting your hands on your hips with thumbs forward and fingers towards your back. The iliac crest is the ridge you can feel under your fingers on each side.
</p>
<p>
...
<Card>
  ...
  <Accordion.Collapse eventKey="18">
    <Card.Body>
      Recovery can take several days, as the bone marrow naturally regenerates. Donors often report their back is sore for anywhere from one to three days afterwards, treatable with over the counter pain relievers. Most return to work within one to two days, and usually return to normal levels of exercise within a week or ten days, depending on how fast the marrow regenerates.
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
  ...
  <Accordion.Collapse eventKey="19">
    <Card.Body>
      Once the bone marrow or blood stem cells are collected and prepared, they are carried in cooled containers by a courier to the transplant center where the recipient will receive his or her transplant. The package never leaves the courier’s hands, and qualifies for a special customs clearance if the transplant center is overseas.
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
  ...
  <Accordion.Collapse eventKey="20">
    <Card.Body>
      Everything in the donation process is designed to ensure that the patient is fully prepared to receive the transplant so he or she will have the best chance of recovery. Sometimes delays occur due to the patient needing more time in the preparation process. A Work Up Coordinator will keep every donor informed as much as possible.
    </Card.Body>
  </Accordion.Collapse>
</Card>
<Card>
  ...
  <Accordion.Collapse eventKey="21">
    <Card.Body>
<p>
Part of the donation process involves a thorough review of any past illnesses or current conditions that may prevent you from donating. Some of these have to do with protecting the donor's health, and most are designed to protect the recipient. Many people who cannot donate bone marrow due to back or hip injuries or conditions may still donate peripheral blood stem cells.
</p>
<p>
Anyone with a <b>temporary condition</b> that prevents them from donating now may be able to donate in the future. This donor's status will be put on hold until a determination is made that he or shee can reenter the registry.
</p>
<p>
<b>Pregnant women</b> may not donate while pregnant, due to the production of antibodies that can cause rejection of the transplant (Graft-Versus-Host disease). Three months after delivery of the child, women may once again donate bone marrow and peripheral stem cells.
</p>
<p>
If a prospective donor is called but later on the <b>donation is cancelled</b>, it is possible that several matches were available and another donor was selected for transplant. The donation coordinator will share available information where possible, but details may not be available from the transplant center.
</p>
  </Card.Body>
  </Accordion.Collapse>
</Card>
...
<p>
<b>Myeloablative transplant</b> involves the use of chemotherapy and/or radiation therapy. The choice of these and how to balance them depends on many factors, so the best treatment regimen for each patient is created by the physician and the transplant center.
</p>
<p>
<b>Non-myeloablative transplant</b> is a reduced-intensity treatment that relies in part on the patient’s own immune system to fight the disease. This method may be an option for older patients.
</p>
</Card.Body>
  </Accordion.Collapse>
</Card>
...
<Card>
  ...
  <Accordion.Collapse eventKey="32">
    <Card.Body>
<p>
On the surface of all cells are proteins, carbohydrates and sugars called “antigens.” Half of these antigens are inherited from the mother and half from the biological father. The immune system identifies these antigens as either “self” or “not-self." In humans these antigens are called <b>Human Leukocyte Antigens</b> (or HLAs for short).
</p>
<p>
When the immune system finds cells that it deems to be "not self," it destroys them to prevent diseases. In the case of a transplant, if the immune cells that came from the donor start to see the recipient's cells as enemies, they may attack the recipient's cells and organs. 
</p>
<p>
...
<p>
Since each parent can give one of two haplotypes to their offspring, there are four possible combinations of haplotypes in each child. Therefore, you have a 25 percent chance of inheriting the same two HLA haplotypes as one of your siblings, but you also have a 25 percent chance of having no matching HLA haplotypes. There is a 50 percent chance that you will share one haplotype with a sibling. Note that blood type is inherited from a different gene and is not related to a person’s HLA type.
</p>
<p>
